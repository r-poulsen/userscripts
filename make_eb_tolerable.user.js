...
window.addEventListener("load", function () {
    [document.getElementById("frontpageLocalNews_")].forEach((el) => {
    ...
    [
        ...
        document.getElementById("myfrontpage"),
        ...document.getElementsByClassName("localnews"),
    ].forEach((el) => {
        if (el !== undefined && el !== null) {
  ...
  */
    ...
    [...document.getElementsByClassName("dre-feature-snippet--plus")].forEach(
        (el) => {
            //unwanted_element(el.parentElement.parentElement.parentElement)
            unwanted_element(el.parentElement.parentElement.parentElement);
        }
